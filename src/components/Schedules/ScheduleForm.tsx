...
export function ScheduleForm({ isOpen, onClose, onSave, classes, selectedClass, schedule }: ScheduleFormProps) {
  ...
  const timeSlots = [
    ...
    { start: '10:30', end: '11:00', label: '10h 30-11h' },
    { start: '11:00', end: '11:30', label: '11h-11h 30' },
    { start: '11:30', end: '12:00', label: '11h 30-12h' },
    { start: '12:00', end: '12:30', label: '12h-12h 30' },
    { start: '12:30', end: '13:00', label: '12h 30-13h' },
    { start: '13:00', end: '13:30', label: '13h-13h 30' },
    { start: '13:30', end: '14:00', label: '13h 30-14h' },
    { start: '14:00', end: '14:30', label: '14h-14h 30' },
    { start: '14:30', end: '15:00', label: '14h 30-15h' },
